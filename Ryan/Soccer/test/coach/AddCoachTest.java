 ...
 * @author Ryan
 * 
 * Purpose: This class tests that you can add a coach to the database. 
 * It first counts how many coaches the database currently has and then attempts 
 * to create one. It counts the database again, and hopefully comes back with a number
 * that is one higher then before. The coach is than deleted.
 */
public class AddCoachTest {
    ...
    public void insertCoach() throws Exception {
        ...
        AddCoach.loadInfo(user); //add the temp user to the database.
