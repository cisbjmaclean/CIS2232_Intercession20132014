...
public class SupportSessionView extends ValidatorForm {
    ...
    private static ArrayList<SupportSessionView> supportSessions = new ArrayList();
    private int supportSessionId;
    private String supportSessionDate;

    public static ArrayList<SupportSessionView> getSupportSessions() {
        return supportSessions;
    }

    public static void setSupportSessions(ArrayList<SupportSessionView> supportSessions) {
        SupportSessionView.supportSessions = supportSessions;
    }
